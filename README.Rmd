...
An R package providing access to 10 baseline forecasting models from the Julia ForecastBaselines.jl library, with uncertainty quantification and seamless integration with the [scoringutils](https://epiforecasts.io/scoringutils/) evaluation framework.
...
- Baseline models for evaluation: Includes simple benchmarks (Constant, Marginal) and specialised models (LSD, IDS, INARCH) designed for comparing against more complex forecasting methods
- Seamless scoringutils integration: Native support for the [scoringutils](https://epiforecasts.io/scoringutils/) evaluation framework and hubverse ecosystem
- Multiple uncertainty quantification methods: Bootstrap-based, analytical, and conformal prediction intervals
...
- Scoring: Compatible with scoringutils for all standard forecast evaluation metrics
