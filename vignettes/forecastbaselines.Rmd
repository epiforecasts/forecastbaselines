...
scoringutils::plot_predictions(
  fc_quantile,
  x = "horizon",
  range = c(0, 50, 95)  # Show median and 50%, 95% prediction intervals
) +
  labs(title = "Constant Model Forecast with Prediction Intervals",
...
scoringutils::plot_predictions(
  arma_quantile,
  x = "horizon",
  range = c(0, 50, 95)  # Show median and 50%, 95% intervals
) +
  labs(title = "ARMA(2,1) Forecast with Prediction Intervals",
       x = "Forecast Horizon", y = "Value") +
  theme_minimal()
```
