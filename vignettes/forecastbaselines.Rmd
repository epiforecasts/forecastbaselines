...
```{r scoring}
# Add truth to forecast (using the truth values generated earlier)
...
set.seed(789)
full_seasonal <- 10 + 5 * sin(2 * pi * (1:252) / 12) + rnorm(252)
seasonal_data <- full_seasonal[1:240]
future_seasonal <- full_seasonal[241:252]
...
hubVis::plot_step_ahead_model_output(
  seasonal_hubverse$model_output,
