...
if (requireNamespace("hubVis", quietly = TRUE) &&
  ...
  model_out <- hubUtils::as_model_out_tbl(constant_hubverse$model_output)
...
if (requireNamespace("hubVis", quietly = TRUE) &&
  requireNamespace("hubUtils", quietly = TRUE)) {
  model_out <- hubUtils::as_model_out_tbl(arma_hubverse$model_output)
  hubVis::plot_step_ahead_model_output(
    model_out,
...
# Generate future observations for truth
set.seed(790)
future_seasonal <- 10 + 5 * sin(2 * pi * (241:252) / 12) + rnorm(12)
...
# Visualize both models with hubVis (if installed)
if (requireNamespace("hubVis", quietly = TRUE) &&
  requireNamespace("hubUtils", quietly = TRUE)) {
  model_out <- hubUtils::as_model_out_tbl(seasonal_hubverse$model_output)
  hubVis::plot_step_ahead_model_output(
    model_out,
