...
- `k`: Number of harmonic waves representing seasonality (default: 1).
  ...
  before any seasonal fit has converged: a series far from zero leaves the
  intercept short, and many parameters leave the seasonal shape poorly
  resolved at any scale. Two waves are accurate on counts around 5 but not at
