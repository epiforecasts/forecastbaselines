...
- `error`: "A" (additive) or "M" (multiplicative). ForecastBaselines.jl fits
  either as an additive error, so asking for "M" warns
...
# Specific: additive error, additive trend, multiplicative season
