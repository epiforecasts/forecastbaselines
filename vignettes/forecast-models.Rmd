...
- `window_width`: Number of similar periods to average (default: 1)
...
- `k`: Number of harmonic waves representing seasonality (default: 1).
  Estimation starts its mean parameters at zero and stops at 1000 iterations.
  One wave converges inside that limit on small-count series; past that, a
  series far from zero leaves the intercept short, and many parameters leave
  the seasonal shape poorly resolved at any scale. Two waves are accurate on counts around 5 but not at
  a mean of 100, and three waves are unreliable either way. Compare the fitted
  mean with the data
