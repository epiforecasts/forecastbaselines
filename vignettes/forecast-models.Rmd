...
- `k`: Number of harmonic waves representing seasonality (default: 1). Each
  wave adds two parameters, and estimation starts from zero, so fits on data
  with a large mean become unreliable beyond one or two waves
