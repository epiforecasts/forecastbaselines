...
- `k`: Number of harmonic waves representing seasonality (default: 1).
  Several waves need more optimiser iterations than ForecastBaselines.jl
  currently allows, so those fits come back part-way through the search;
  compare the fitted mean with the data
