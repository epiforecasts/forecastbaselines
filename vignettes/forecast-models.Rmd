...
- `k`: Number of harmonic waves representing seasonality (default: 1).
  Estimation starts from zero and stops at 1000 iterations, so several waves
  on a series far from zero fall short of the fit: two waves are accurate on
  counts around 5 but not at a mean of 100, and three waves fail at either
  scale. Compare the fitted mean with the data
