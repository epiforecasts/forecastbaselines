...
#'   far from the data; the risk grows with the number of waves, and two waves
#'   already fail on many series. Compare the fitted mean with the data before
#'   trusting a seasonal fit.
