...
#'   scale. Given more iterations the same fits converge, which makes this a
#'   limit of the estimator rather than of the model. Compare the fitted mean
#'   with the data before trusting a seasonal fit.
